      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <a href="tel:+919050111113" className="hidden sm:inline-flex" data-testid="link-call-header">
              ...
              <SheetContent side="right" className="w-[280px] sm:w-[350px]">
                ...
                <nav className="flex flex-col gap-2 mt-8" data-testid="nav-mobile">
                  ...
                  <div className="mt-4 pt-4 border-t">
                    <a href="tel:+919050111113" className="block" data-testid="link-call-mobile">
